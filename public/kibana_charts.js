...
function launchChart(window, absUrl, chartType, argPopup, selected_index_config) {
	...
	var logFieldName = "lt." + event.sourcePattern.fields[argPopup.argNum-1];
	...
	var url = absUrl.substr(0,absUrl.indexOf('logtrail'));
