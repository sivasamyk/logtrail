...
- Install logtrail plugin (requires restart of Kibana after install)
  - Kibana 5.5.0 : `./bin/kibana-plugin install https://github.com/sivasamyk/logtrail/releases/download/v0.1.18/logtrail-5.5.0-0.1.18.zip`
